...
hsi::open_hw_design $out_dir/daphne3_str_$git_sha.xsa

# generate the device tree using the generated XSA
createdts -hw $hw -zocl -platform-name daphne3_str_$git_sha -git-branch xlnx_rel_v2022.2 -overlay -compile -out $out_dir/daphne3_str_$git_sha
