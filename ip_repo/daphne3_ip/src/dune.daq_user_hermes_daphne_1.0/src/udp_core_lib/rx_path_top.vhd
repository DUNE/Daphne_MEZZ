...
begin
    ...
    rx_in_fifo_inst : entity work.axi4s_fifo
        generic map(
    ...
    rx_in_pipe_inst : entity work.udp_axi4s_pipe
        generic map(
            G_STAGES       => 2,
            G_BACKPRESSURE => true
        )
    ...
    filter_stage_1_inst : entity work.rx_filter_stage_1
        generic map(
    ...
    filter_stage_2_inst : entity work.rx_filter_stage_2
        generic map(
    ...
    filter_stage_3_inst : entity work.rx_filter_stage_3
        generic map(
            G_UDP_CORE_BYTES => G_UDP_CORE_BYTES
        )
        port map(
