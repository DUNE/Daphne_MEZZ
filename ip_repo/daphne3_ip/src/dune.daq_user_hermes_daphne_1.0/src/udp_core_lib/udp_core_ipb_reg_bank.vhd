...
begin
    ...
    udp_core_settings : entity work.udp_core_settings_ipb_reg_bank
    port map(
        clk         => clk,
        rst         => rst,
    ...
    lut_gen: if G_INC_LUTS generate
        arp_mode_ctrl : entity work.arp_mode_ctrl_ibp_reg_bank
        generic map(
        ...
        udp_core_farm_mode_luts: entity work.udp_farm_mode_luts_ipb_reg_bank
        generic map(
