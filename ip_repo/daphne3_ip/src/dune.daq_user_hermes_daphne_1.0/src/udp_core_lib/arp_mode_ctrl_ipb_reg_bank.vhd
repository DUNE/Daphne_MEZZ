...
begin
    ...
    arp_mode_ctrl_bank : entity work.ipbus_ctrlreg_v
    generic map(
    ...
    pos_act_bank : entity work.ipbus_ctrlreg_v
    generic map(
    ...
    timeout_nz_bank : entity work.ipbus_ctrlreg_nz_bank
    generic map(
        N_REG => N_NZ_REG
    )
    port map(
    ...
    arp_mode_entry_bank : entity work.ipbus_ctrlreg_v
    generic map(
        N_CTRL => 0,
